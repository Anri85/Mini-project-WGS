    ...
    return (
        <>
            ...
            <nav className="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                <div className="w-full flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                    {/* Brand */}
                    {/* <a className="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="#pablo" onClick={(e) => e.preventDefault()}>
                        Dashboard
                    </a> */}
                    {/* Form */}
                    <form className="md:flex hidden flex-row flex-wrap items-center mt-3 mr-3">
